...
class DeleteMainDrinkService {

  var message;

  var url = Uri.parse(ServerConfig.domainNameServer + ServerConfig.deleteDrink);

  Future<bool> deleteMainDrink(DeleteMainMealDrink deleteMainMealDrink) async{
