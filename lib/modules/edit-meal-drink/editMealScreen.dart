...
class editMealScreen extends GetView<EditMealController>{
    ...
    return Scaffold(
      body: Theme(
        ...
        child: SingleChildScrollView(
          child: Center(
            child: Form(
              key: controller.editMealsFormKey,
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Obx( ()=> CustomDropdownButton(
                      ...
                      items: controller.mealCategories.map((category) => category.name).toList(),
                      width: 250.0,
                    ),),
                    SizedBox(
                      height: 10.0,
