...
class addMealScreen extends GetView<AddMealController>{
                ...
                child:  Column(
                  ...
                  children: [
                    ...
                    Obx (() => DropdownButton<String>(
                      ...
                      items: controller.mealCategories.map<DropdownMenuItem<String>>((category) {
  ...
  void onClickAddMeal() async{
    EasyLoading.show(status: "loading...");

    await controller.addMealOnClick();

    if(controller.addMealStatus){
      ...
      //
      // Call the updateMainMealList function to update main meals list
      Get.find<MainMealsController>().updateMainMealList();
      //
