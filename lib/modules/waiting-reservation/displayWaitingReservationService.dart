...
class DisplayWaitingReservationService {

  var message;

  var url = Uri.parse(ServerConfig.domainNameServer + ServerConfig.displayWaitReservation);

  Future<List<Reservation>> displayWaitingReservation(var token) async{
    try {
