...
class waitingReservationScreen extends GetView<WaitingReservationController> {
                                    ...
                                    child: Row(
                                      ...
                                      children: [
                                        CustomElevatedButton(
                                          onPressed: (){
                                            onClickSetDoneReservation(reservation);
                                          },
                                          buttonText: "Set Done",
                                          height: 30.0,
  ...
  void onClickSetDoneReservation(Reservation reservation) async{
