...
class drinkDetailsScreen extends GetView<DrinkDetailsController> {


  @override
  Widget build(BuildContext context) {

    var selectedDrink = Get.arguments as MealsDrinks;
          ...
          Container(
            ...
            decoration: BoxDecoration(
              image: DecorationImage(
                image: NetworkImage(selectedDrink.image),
                fit: BoxFit.cover,
              ),
            ),
          ),
                        ...
                        Expanded(
                          child: Align(
                            ...
                            child: RatingBar.builder(
                              initialRating: selectedDrink.rate!.toDouble(),
                              //minRating: 1,
