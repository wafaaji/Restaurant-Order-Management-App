...
class DisplayActiveOffersService {

  var message;

  var url = Uri.parse(ServerConfig.domainNameServer + ServerConfig.displayActiveOffers);

  Future<List<Offers>> displayActiveOffers(var token) async{
    try {
