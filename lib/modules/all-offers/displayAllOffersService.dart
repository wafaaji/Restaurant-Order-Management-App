...
class DisplayAllOffersService {

  var message;

  var url = Uri.parse(ServerConfig.domainNameServer + ServerConfig.displayOffers);

  Future<List<Offers>> displayAllOffers(var token) async{
    try {
